...
<html>
    ...
    <body>
        ...
        <div id="show-registroConsulta" class="content scaffold-show" role="main">
            ...
            <f:display bean="registroConsulta" />
            <g:form resource="${this.registroConsulta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.registroConsulta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
